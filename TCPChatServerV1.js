 ...
 server.on('connection', function(socket) 
	...
	*/
	socket.on('data', function(data) 
		...
		/* Now we have all the connection in one array we can easily communicate with them.
		   In a chat server we will want to distribute every new message to every connected
